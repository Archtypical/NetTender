...
#define NET_ENABLE_WEB_SERVER       true
...
- Build uses -fno-rtti for memory savings
- Use string comparison or other type identification methods
...
- Ensure NET_ENABLE_WEB_SERVER is true in NetworkConfig.h
